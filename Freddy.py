...
tabs = st.tabs([
    "🏅 Career Overview", "📊 Performance & Stats", "📍 Position & Role",
    "🛡 Player Profile", "📈 Physical & Health", "⚖️ Well-being"
])

with tabs[0]:
    st.subheader("👤 Player Career | Young player ready for a new step")
...
with tabs[1]:
    ...
    st.subheader("📊 Player Comparison | Ernest Nuamah")
    ...
    st.subheader("⚽ Shot Map | Efficiency")
...
with tabs[2]:
    st.subheader("📍 Position Played | Left Winger & Versatile Forward")
...
with tabs[3]:
    st.subheader("🛡 Player Profile | Wide Threat - Explosive & Dribbler")
...
with tabs[4]:
    st.subheader("🏋️ Physical Performance | High Intensity & Explosiveness")
...
st.markdown("<hr style='border:1px solid #ddd' />", unsafe_allow_html=True)
st.success("✅ Updated player profile with structured insights and better navigation!")
